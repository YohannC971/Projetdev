...
<head>
    ...
    <title>Listes des candidats acceptés</title>
    <!-- Font Awesome -->
...
WHERE f.datevalidation IS NOT NULL AND c.Etat_admission = 1;
";
...
echo "</div>";
    ...
    echo "Aucun Candidat acceptés trouvé dans la base de données.";
}
