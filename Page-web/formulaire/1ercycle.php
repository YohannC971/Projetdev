  ...
  <div class="container pt-4" style="border-color: black; border-radius: 10px;">
    ...
    <div class="d-flex flex-column mb-3">
      ...
      <div class="d-flex" style="border: 2px solid black;">
        ...
        <form action="controleur-1ercycle.php" method="post" target="_blank" enctype="multipart/form-data">
...
<script>
  function suivant() {
    window.location.href = "diplome.html"; // Remplacez l'URL par celle de la page suivante
  }
  </script>
