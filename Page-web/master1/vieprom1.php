    ...
    <div class="d-flex flex-column mb-3">
      ...
      <div class="d-flex" style="border: 2px solid black;">
        ...
        <div class="p-2" style="border-bottom: 2px solid black; width: 200px;border-right: 2px solid black; width: 200px;"><h5><a href="candidaterm1.php">Information du candidat</a> </h5></div>
          ...
          <div class="p-2" style="border-bottom: 2px solid black; width: 200px;border-right: 2px solid black; width: 200px;"><h5><a href="piece_justficatifm1.php">Pieces justificatif</a> </h5></div>
        ...
        <form action="controleur-vieprom1.php" method="post" enctype="multipart/form-data">
...
<script>
  function suivant() {
    window.location.href = "piece_justficatifm1.php"; // Remplacez l'URL par celle de la page suivante
  }
  </script>
