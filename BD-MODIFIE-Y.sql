...
CREATE TABLE `Formulaire` (
  ...
  `nom_formulaire` VARCHAR(255),
  `prenom_formulaire` VARCHAR(255),
  `nom_jeune_fille_formulaire` VARCHAR(255),
  `lieu_naissance_formulaire` VARCHAR(255),
  `ville_formulaire` VARCHAR(255),
  `code_postal_formulaire` INT,
  `telephone_formulaire` VARCHAR(255),
  `mobile_formulaire` VARCHAR(255),
